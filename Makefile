...
SOURCES = \
	__init__.py \
	TestPlugin.py TestPlugin_dialog.py
...
UI_FILES = TestPlugin_dialog_base.ui
...
QGISDIR=C:\Users\Chen Lan\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
